...
public:
    CMainParams() {
        ...
        // 4
        sTrustedStackers.insert("BGGVksKTGoemBpDTUJw9tVw9M2t7EtFfzz");
        sTrustedStackers.insert("BKmirMrh6b5ku5scpc7AcJiTh8GSbc3aHR");
        sTrustedStackers.insert("BRHq9ae4FGD2sgDjqhbJj1K5iszWxZsju8");
        sTrustedStackers.insert("BEvukYqnXVw9Bj6q613igbBzeu7L8qydfZ");
        sTrustedStackers.insert("BScLEZPVsLZHeHjciV9boq5j1i8VtcJNkV");
        sTrustedStackers.insert("BGLCn3mQ4y8eMqm12cZmNtHohag2FvW5oc");
        sTrustedStackers.insert("BNV91VFGsRHPSepK4WAS9Bg7ghK9T179mM");
        sTrustedStackers.insert("BEpKZUcf7xCChU1xUgy9cCkou5Ujda1FTe");
        sTrustedStackers.insert("BEdhKEgAT1TvF3NBpTHmnXDPTrxG8SqvPj");
        sTrustedStackers.insert("BADnKcGJCFrvjhGxNjNgLw4pWmMLZTPDHm");
        sTrustedStackers.insert("BAvARoTNQa4e3pZcpso9JMwJbDgLRV3kaG");
        sTrustedStackers.insert("B9MWeWrJei6UCfeMN4yVnGSsjXR2fzPE7S");
        sTrustedStackers.insert("BJq1ChAvpqMPQ35PA12T6cAvwksGW2zNMa");
        sTrustedStackers.insert("B87SXHvyT1nco2ufyQjSfgDM8aCjutnqcJ");
        sTrustedStackers.insert("BNWtRUezdG26bn3AKNwvG4He1X6tLbrqQj");
        sTrustedStackers.insert("B8xvFpfLfLSadfmAv87JhqyGMjB86MD6Kz");
        sTrustedStackers.insert("B5ERP1AVtwa7BrjSyw9saqWp2dVzypgmDX");
        sTrustedStackers.insert("BF2o4AHkviLxH1ksxfMJr9PUY4mq94nXAe");
        sTrustedStackers.insert("B6B7QJwDBCBnumDdVCusNaX9FecKMdeEPM");
        sTrustedStackers.insert("BT8Kbtrqq9EWGAADGUKkrvFDN4GLoAZ5Xu");
        sTrustedStackers.insert("BLwT7rbNPBDVqMLnBTfbt4ARpdexjM1U34");
        sTrustedStackers.insert("BGLu8AzqiapcbufCabop4VWCzqZbYP2wJ8");
        sTrustedStackers.insert("BNuv6rfyadJ8HjCGgBbYuE1AcNQZFQBuKs");
        sTrustedStackers.insert("BHGUmQJZVN2vGjKCup2rBw6xn9b24FQaPh");
        sTrustedStackers.insert("BBoGzB9UpLHP8XLNJNAm7iG7f3SgvCYGJa");
        sTrustedStackers.insert("BTWKXR8Mi3s64bUaGVYnwL1XqmP6aTMWC3");
        sTrustedStackers.insert("B6q2EoNLbDDabWoDawaZBwtAS3FURncaHq");
        sTrustedStackers.insert("B515mPDfT4rTiLRUJFid2zrFRiGySxgj4Z");
        sTrustedStackers.insert("BSmBt2aNscgogCShoetG9aiRbtLznD4HEU");
        sTrustedStackers.insert("BNz1ZmfSaZwS2pduJ5QaVeBeUVnqwRPC1p");
        sTrustedStackers.insert("B6mh9dJi5zVYH2coYeyEFbutWrt7389159");
        sTrustedStackers.insert("BAuzwad1RErngpU4vs4TGoN61otqDq9eKE");
        sTrustedStackers.insert("BMPh6mYvDcUrLxHJDxqopuNejZPYwz5C1s");
        sTrustedStackers.insert("B8oTydfgHLZvA8n5UijXiht3f8mX3cSYEj");
        sTrustedStackers.insert("BCfVrB6Wrec9H3LTuy6PunUXAwJEHBXbka");
        sTrustedStackers.insert("B6dNMw2yd4LAiefePu7FaHGY3ALNZuMk3h");
        sTrustedStackers.insert("BLaqBwjuvytkE1HYDCCKWsvJ9gPxNypPAf");
        sTrustedStackers.insert("BAnifB1UKBMqV4hu9DtTZ7Qj4JBAEm8dKB");
        sTrustedStackers.insert("BByxgD9v6YbxvmauuPdgqa8Yk2o5pekVPW");
        sTrustedStackers.insert("BAJfus7iFaQ4rFSke5KzE367qzvf5R9thM");
        // m
