...
public:
	...
	CTxIndex(const CDiskTxPos& posIn, unsigned int nOutputs, int64_t nHeight, uint16_t nTxIndex) {
		SetNull();
		pos = posIn;
...
public:
	...
	std::string ToString() const {
		return strprintf(
		    ...
		    nPegSupplyIndex, nPegVotesInflate, nPegVotesDeflate, nPegVotesNochange,
