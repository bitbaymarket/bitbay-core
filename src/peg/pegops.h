...
extern bool getpeglevel(int                inp_cycle_now,
                        int                inp_cycle_prev,
                        int                inp_buffer,
                        int                inp_peg_now,
                        int                inp_peg_next,
...
extern bool getpeglevelinfo(const std::string& inp_peglevel_hex,
...
extern bool getpegdatainfo(const std::string& inp_pegdata64,
...
extern bool updatepegbalances(const std::string& inp_balance_pegdata64,
...
extern bool movecoins(int64_t            inp_move_amount,
...
extern bool moveliquid(int64_t            inp_move_liquid,
                       const std::string& inp_src_pegdata64,
                       const std::string& inp_dst_pegdata64,
                       const std::string& inp_peglevel_hex,
...
extern bool movereserve(int64_t            inp_move_reserve,
                        const std::string& inp_src_pegdata64,
                        const std::string& inp_dst_pegdata64,
                        const std::string& inp_peglevel_hex,
...
extern bool removecoins(const std::string& inp_from_pegdata64,
...
extern bool updatetxout(const std::string  inp_txout_pegdata64,
                        const std::string& inp_peglevel_hex,
...
extern bool prepareliquidwithdraw(const txinps&      inp_txinps,
...
extern bool preparereservewithdraw(const txinps&      inp_txinps,
                                   const std::string  inp_balance_pegdata64,
                                   const std::string  inp_exchange_pegdata64,
                                   const std::string  inp_pegshift_pegdata64,
                                   int64_t            inp_amount_with_fee,
