...
void TestPegOps::test4()
{
    ...
    QVERIFY(ok == true);
    QVERIFY(out_pegpool_pegdata64 == "AgACAAAAAAABAgACAAAAAAAAAAAAACAAAAAAAAAAeNrtwTEBAAAAwqD1T20Hb6AAAAAAAAAAAAB4DCWAAAH3by0AAAAAAABuLQAAAAAAAPcA+gD9AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA3HHzu");
}
...
void TestPegOps::test4a()
{
    ...
    QVERIFY(src_out_b64 == "AgACAAAAAAABAgACAAAAAAAAAAAAACUAAAAAAAAAeNrtxUERAAAIA6DZv7Q15gkfEgAAAAAAAOCKeT4AQJsFSg8AIQECAAAAAAAAAAEAAAAAAAAA9wH3AfcBAAC0AAAAAAAAAEsBAAAAAAAAAAAAAAAAAAAgAAAAAAAAAAAAAAA=");
    QVERIFY(dst_out_b64 == "AgACAAAAAAABAgACAAAAAAAAAAAAAFAAAAAAAAAAeNrt1rENACAIBEBl/6FdQAtDoZC7hlhYGJ/AGAAAAMDvptq6or93ecjm6XWe5ZtMP2T7o/v8jKLvjMv/i8P59n7VvcCepNofAQDqWIBCAPkBAgAAAAAAAAABAAAAAAAAAPcB9wH3AQAAtAAAAAAAAABLAQAAAAAAAAAAAAAAAAAAGwEAAAAAAAAAAAAA");
}
