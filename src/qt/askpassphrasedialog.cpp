	...
	switch (mode) {
		case Encrypt:  // Ask passphrase x2
			...
			ui->warningLabel->setText(
			    tr("Enter the new passphrase to the wallet.<br/>Please use a passphrase of <b>ten "
			       "or more random characters</b>, or <b>eight or more words</b>."));
	...
	switch (mode) {
						...
						QMessageBox::warning(
						    ...
						    "<qt>" +
						        tr("BitBay will close now to finish the encryption process. "
						           ...
						           "your coins from being stolen by malware infecting your "
						           "computer.") +
						        "<br><br><b>" +
						        tr("IMPORTANT: Any previous backups you have made of your wallet "
						           "file "
						           "should be replaced with the newly generated, encrypted wallet "
						           "file. "
						           "For security reasons, previous backups of the unencrypted "
						           "wallet file "
		...
		case Decrypt:
			if (!model->setWalletEncrypted(false, oldpass)) {
				QMessageBox::critical(
				    this, tr("Wallet decryption failed"),
				    tr("The passphrase entered for the wallet decryption was incorrect."));
			} else {
				QDialog::accept();  // Success
			}
