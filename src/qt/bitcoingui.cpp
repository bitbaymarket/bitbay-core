...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        connect(clientModel, SIGNAL(message(QString,QString,bool,uint32_t)), this, SLOT(message(QString,QString,bool,uint32_t)));
...
void BitcoinGUI::setWalletModel(WalletModel *walletModel)
{
    ...
    if(walletModel)
    {
        ...
        connect(walletModel, SIGNAL(message(QString,QString,bool,uint32_t)), this, SLOT(message(QString,QString,bool,uint32_t)));
