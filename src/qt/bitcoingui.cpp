...
void BitcoinGUI::setClientModel(ClientModel* clientModel) {
	...
	if (clientModel) {
		...
		connect(clientModel, SIGNAL(message(QString, QString, bool, unsigned int)), this,
		        SLOT(message(QString, QString, bool, unsigned int)));
...
void BitcoinGUI::setWalletModel(WalletModel* walletModel) {
	...
	if (walletModel) {
		...
		connect(walletModel, SIGNAL(message(QString, QString, bool, unsigned int)), this,
		        SLOT(message(QString, QString, bool, unsigned int)));
