...
/**
  Bitcoin GUI main class. This class represents the main window of the Bitcoin UI. It communicates
  with both the client and wallet models to give the user an up-to-date view of the current core
  state.
*/
...
public:
	...
	/** Set the client model.
	    The client model represents the part of the core that communicates with the P2P network, and
	   is wallet-agnostic.
	*/
...
public slots:
	...
	*/
	...
	/** Notify the user of an event from the core network or transaction handling code.
	   ...
	   @param[in] style     style definitions (icon and used buttons - buttons only for message
	   boxes)
