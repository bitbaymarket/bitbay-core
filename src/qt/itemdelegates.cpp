...
LeftSideIconItemDelegate::LeftSideIconItemDelegate(QWidget* parent) : QStyledItemDelegate(parent) {}
...
FractionsItemDelegate::FractionsItemDelegate(QWidget* parent) : QStyledItemDelegate(parent) {}
