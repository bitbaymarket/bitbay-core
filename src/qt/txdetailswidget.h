...
public:
	TxDetailsWidgetTxEvents(QTreeWidget* w, QObject* parent) : QObject(parent), treeWidget(w) {}
...
public:
	FractionsDialogEvents(QTreeWidget* w, QObject* parent) : QObject(parent), treeWidget(w) {}
