...
WalletModel::WalletModel(CWallet *wallet, OptionsModel *optionsModel, QObject *parent) :
    ...
    cachedBalance(0), cachedReserves(0), cachedLiquidity(0),
...
qint64 WalletModel::getReserves(const CCoinControl *coinControl) const
{
    if (coinControl)
    {
        qint64 nBalance = 0;
